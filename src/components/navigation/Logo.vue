<template>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="#ddd" width="24px" height="24px">
        <title>4chan</title>
    ...
    <h1 v-if="showText" class="font-bold text-slate-50 pl-3" >後台管理系統</h1>
    </div>
</template>
